...
urlpatterns = [
    ...
    path('livros/<int:livro_id>/', views.data_livro, name='dados_livros'),
    ...
    path('meus_emprestimos/<int:livro_id>/', views.visualizar_pdf, name='visualizar_pdf'),
    path('licenca_expirada/', views.licenca_expirada, name='licenca_expirada'),
    path('livros/renovar/<int:livro_id>/', views.renovar_emprestimo, name='renovar_emprestimo'),
    path('buscar/', views.search, name='search'),
    path('dashboard/', views.dashboard, name='dashboard'),
    path('autores/edit_autor/<int:autor_id>/', views.edit_autor, name='edit_autor'),
    path('categorias/edit_categoria/<int:categoria_id>/', views.edit_categoria, name='edit_categoria'),
    path('editoras/edit_editora/<int:editora_id>/', views.edit_editora, name='edit_editora'),
]